---
title: "Nominal novel and exist shape and parity"
...
model10year <- 
  paste("
      model {
        ...
        for(i in 1:2){
          bPaceXStPopSz[i] ~ dunif(-5,5)
        }
        
        for(i in 1:2){
          bPaceXShape[i] ~ dunif(-5,5)
        }
        ...
        for(i in 1:2){
          for(j in 1:4){
            bPaceXstart[i,j] ~ dunif(-5,5)
          }
        }
        
        # bStPopSzXStart
        for(i in 1:4){
          bStPopSzXStart[i] ~ dunif(-5,5)
        }
        
        # bShapeXStart
        for(i in 1:4){
          bShapeXStart[i] ~ dunif(-5,5)
        }
        
        bStPopSz ~ dunif(-5,5)
        bShapeItero ~ dunif(-5,5)
...
save(res1, file = paste("C:/Users/DePrengm/OneDrive - Denver Botanic Gardens/P drive/My Documents/UCDenver_phd/Dissertation/Chapter3/Rdatas/binomialFamRndm10yrs_SSD10000sample1",Sys.Date(),".Rdata", sep=""))

# load("C:/Users/deprengm/OneDrive - Denver Botanic Gardens/P drive/My Documents/UCDenver_phd/Dissertation/Chapter3/Rdatas/binomialFamRndm10yrs_SSD10000sample12023-06-19.Rdata")
```
...
save(resExistParity, file = paste("C:/Users/DePrengm/OneDrive - Denver Botanic Gardens/P drive/My Documents/UCDenver_phd/Dissertation/Chapter3/Rdatas/ExistParity",Sys.Date(),".Rdata", sep=""))
...
# load("C:/Users/deprengm/OneDrive - Denver Botanic Gardens/P drive/My Documents/UCDenver_phd/Dissertation/Chapter3/Rdatas/ExistParity2023-06-21.Rdata")
...
resNovelParity <- jags(jags.data, inits = NULL, parameters, 
            ...
            n.iter = ni, n.burnin = nb,
            working.directory = getwd()) 
save(resNovelParity, file = paste("C:/Users/DePrengm/OneDrive - Denver Botanic Gardens/P drive/My Documents/UCDenver_phd/Dissertation/Chapter3/Rdatas/modelNovelParity",Sys.Date(),"..Rdata", sep=""))
...
save(resNovelshape, file = paste("C:/Users/DePrengm/OneDrive - Denver Botanic Gardens/P drive/My Documents/UCDenver_phd/Dissertation/Chapter3/Rdatas/binomialFamRndm10yrSeedShape",Sys.Date(),".Rdata", sep=""))
...
# load("C:/Users/deprengm/OneDrive - Denver Botanic Gardens/P drive/My Documents/UCDenver_phd/Dissertation/Chapter3/Rdatas/binomialFamRndm10yrSeedShape2023-06-21.Rdata")
```
